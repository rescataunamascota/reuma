...
<body>
            ...
            <form name="form_login" method="post" action="login.php" role="form">
               <fieldset>
                  ...
                  <div class="form-group">
                     <input name="user_id" type="text" id="email" class="form-control input-lg" placeholder="Email Address">
                  </div>
                  <div class="form-group">
                     <input type="password" name="password" id="clave" class="form-control input-lg" placeholder="Password">
                  </div>
   ...
   if (isset($_REQUEST['Submit'])) //here give the name of your button on which you would like    //to perform action.
   {
      ...
      if ($_REQUEST['email'] == "" || $_REQUEST['clave'] == "") {
         echo " Field must be filled";
      } else {
         $sql1 = "select * from admins where email= '" . $_REQUEST['email'] . "' &&  password ='" . $_REQUEST['clave'] . "'";
